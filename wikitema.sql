...
CREATE TABLE if not exists `wikitema`.`commentaire` (
  ...
  `commentaire_date_created` datetime NOT NULL,
...
(1, 'admin', 'admin', '$2y$10$2MHF6rakOluCwdj6N0lg8u2/pxh3w9EwbXm5TX6ejzzu3J5t21HK.', 'admin@hitema.com', NULL, '2017-07-05 12:00:00', 1),
(2, 'jdoe', 'jdoe', '$2y$10$9EIunEjtkDZweLw6RNO8I.1G3n0qwgDUATYN.fW.DZEkIAW7IELya', 'jondoe@hitema.com', NULL, '2017-07-06 12:00:00', 2),
(3, 'test', 'test', '$2y$10$O/jNWYavHxUOCFTM5Hf3J.1bNIAJEF7AcPVS1e1hepPEGJeSSTkcK', 'test@hitema.com', NULL, '2017-07-06 12:00:00', 3);
...
VALUES (1, '1', 'test', 'test', 1, '2017-07-06 12:00:00');
...
VALUES (1, '1', '1', 'test', '2017-07-07 12:00:00');
