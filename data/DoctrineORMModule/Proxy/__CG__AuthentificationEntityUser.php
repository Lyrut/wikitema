...
namespace DoctrineORMModule\Proxy\__CG__\Authentification\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Authentification\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'email', 'pseudo', 'fullName', 'password', 'dateCreated', 'token', 'role'];
        }
